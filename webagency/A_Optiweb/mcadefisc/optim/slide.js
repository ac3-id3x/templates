$(document).ready(function(){
	$("div")
		...
		.end();
		$("div")
		.filter(".menu-Optim3")//1 - modifier ce nom pour chaque cadre
			.hide()
		.end()
		.filter(".Optim3")////2 - modifier ce nom pour chaque cadre
			.click(function(){
				$("div.menu-Optim3").slideDown("slow");//3 - ne pas oublier de changer le nom ici pour que ce soit le memequ'en 1
			})
		.hoverIntent(function(){
				$("div.menu-Optim3").slideUp("slow");//3 - ne pas oublier de changer le nom ici pour que ce soit le memequ'en 1
			},function(){
			 $("div.menu-Optim3").slideUp("slow");//3 - ne pas oublier de changer le nom ici pour que ce soit le memequ'en 1
			})
		.end();
