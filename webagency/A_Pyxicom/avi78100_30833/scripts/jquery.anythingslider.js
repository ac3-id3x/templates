...
(function($) {
	...
	$.anythingSlider = function(el, options) {
			...
			if (o.buildNavigation && (base.pages > 1)) {
				base.$items.filter(':not(.cloned)').each(function(i) {
					...
					if ($.isFunction(o.navigationFormatter)) {
						tmp = new Array();
						tmp = o.infosslide;
				    tmp = tmp [o.navigationFormatter(index, $(this))];
		...
		base.buildNextBackButtons = function() {
			...
			if($(el).attr('id')=='slider')
				{
					base.$forward = $('<span class="arrow forward btnf0"><a href="#"><span>' + o.forwardText + '</span></a></span>');
					base.$back = $('<span class="arrow back btnb0"><a href="#"><span>' + o.backText + '</span></a></span>');
				}
			if($(el).attr('id')=='slider2')
				{
					base.$forward = $('<span class="arrow forward btnf1"><a href="#"><span>' + o.forwardText + '</span></a></span>');
					base.$back = $('<span class="arrow back btnb1"><a href="#"><span>' + o.backText + '</span></a></span>');
				}
			if($(el).attr('id')=='slider3')
				{
					base.$forward = $('<span class="arrow forward btnf2"><a href="#"><span>' + o.forwardText + '</span></a></span>');
					base.$back = $('<span class="arrow back btnb2"><a href="#"><span>' + o.backText + '</span></a></span>');
				}
			...
			$('#flash').prepend(base.$forward).prepend(base.$back);
	...
	$.anythingSlider.defaults = {
		...
		height              : 495,      // Override the default CSS height
