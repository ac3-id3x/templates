        ...
        // core utility and animation methods
            core = {
                ...
                setStyles : function() {                    
					...
					$('.selectionDescr').hide();$('.descr0').show();
                ...
                triggerSlide : function(e) {
					...
					$('.forward,.back').hide();$('.btnf'+core.currentSlide+',.btnb'+core.currentSlide).show();
					$('.selectionDescr').hide();$('.descr'+core.currentSlide).show();
