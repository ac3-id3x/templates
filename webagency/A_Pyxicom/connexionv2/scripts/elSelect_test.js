	...
	*/
	...
	onOptionClick : function(e) {
		...
		if ( this.selected != event.target ) {
			...
			tt=this.selectedOption.setText(this.selected.getText());
			this.hiddenInput.setProperty('value',this.selected.getProperty('value'));
			if (tt.innerHTML == "Locations") {
				document.getElementById("mySelect3").style.display="none";
				document.getElementById("mySelect5").style.display="block";
			}
			else {
				document.getElementById("mySelect3").style.display="block";
