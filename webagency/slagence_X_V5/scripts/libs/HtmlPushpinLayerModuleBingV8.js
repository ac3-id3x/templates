...
var HtmlPushpin = function (loc, html, anchor, clickEvent) {
    this.location = loc;
    ...
    this._element.addEventListener('click', function (e) {
        e.target = that;
        if (clickEvent) clickEvent(e, that); 
    });
...
HtmlPushpinLayer.prototype.onAdd = function () {
    ...
    this.container.className = "CustomOverlay";
...
Microsoft.Maps.moduleLoaded('HtmlPushpinLayerModuleBingV8');