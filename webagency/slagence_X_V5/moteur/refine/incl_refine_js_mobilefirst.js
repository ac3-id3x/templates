...
$$BFIN$$

    {
        ...
        "ttl_nb":"$$IF=:0:ANNLISTE:NBRESULT$$$$LG:AUCUNRESULTAT pcase$$ $$LG:LIEN:RECH lcase$$$$END$$$$IF!:0:ANNLISTE:NBRESULT$$$$ANNLISTE:NBRESULT formatnumber 0$$ $$IF=:1:ANNLISTE:NBRESULT$$$$LG:ANNONCE lcase$$$$END$$$$IF+:2:ANNLISTE:NBRESULT$$$$LG:ANNONCES lcase$$$$IF-:200:ANNLISTE:NBRESULT$$$$END$$$$IF+:200:ANNLISTE:NBRESULT$$<sup>*</sup>$$END$$$$END$$$$END$$",
        "ttl_more":"$$IF!:0:ANNLISTE:NBRESULT$$$$IF+:200:ANNLISTE:NBRESULT$$($$LG:200PREMIERES lcase$$)$$END$$$$END$$",
