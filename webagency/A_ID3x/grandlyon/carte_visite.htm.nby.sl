...
<html>
<head>
<title>Agence Immobilière GIE ORPI DORDOGNE</title>
...
<table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	<td>
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td width="193"><img src="images/enceinte.jpg" width="190" height="101"></td>
		  <td bgcolor="DB3549">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr bgcolor="#CCCCCC">
				<td width="14%">&nbsp;</td>
				<td width="86%" bgcolor="#CCCCCC"> <B><FONT SIZE="3"> $$IMMOBW:AGENCE:NOM$$<BR>
	...
	<td>
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr bgcolor="C24B67">
		  ...
		  <td width="79%" bgcolor="DB3549">
			<center>
			  ...
			  <B><font size="1" color="#FFCC00">$$IMMOBW:NBANN:NBANN$$ annonce$$IMMOBW:NBANN:NBANN
		...
		<tr bgcolor="C24B67">
		  ...
		  <td width="79%" bgcolor="DB3549">
			<center>
			  $$B:IMMOBW:AGENCETRANSACTIONS:REP:1$$
			  	$$BIF:IMMOBW:AGENCETRANSACTIONS:REP$$
			  		$$DO:0:99$$
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td width="43%">
				  <center>
					<img src="pop/enceinte2.jpg" width="150" height="210" border="1">
				  </center>
				</td>
				<td width="57%">
				  <center>
					<img src="/photos_agences/$$REP:1$$.jpg" border="1">
				  </center>
				</td>
			  </tr>
			</table>
			<center>
			  ...
			  <table width="90%" border="0" cellspacing="0" cellpadding="0">
				<tr>
				  <td>$$IMMOBW:TXT_PUBLIC$$</td>
				</tr>
			  </table>
			  $$IF=:98369:REP:1$$<br>
			  Perigueux Immobilier vous apporte une solution globale &agrave;
			  vos probl&egrave;mes immobiliers :<br>
			  - Achats et Ventes rapides au prix du march&eacute; en toute s&eacute;curit&eacute;,<br>
			  - Locations sur toute la ville et les environs soigneusement s&eacute;lectionn&eacute;s,<br>
			  - Gestions de vos biens avec la garantie des loyers impay&eacute;s,<br>
			  - Conseil en copropri&eacute;t&eacute; &agrave; l'&eacute;coute
			  de vos besoins,<br>
  ...
  <tr>
		  <td width="11%"><img src="pop/haut_orpi.gif" width="92" height="28"></td>
		  <td width="89%" bgcolor="DB3549">&nbsp;</td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td><img src="pop/arc.gif" width="500" height="56"></td>
		</tr>
	  </table>
	</td>
  </tr>
