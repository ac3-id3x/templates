...
<BODY onLoad="preloadImages('/z/sla/slagence_fpi83/Images/voletsC.gif','/z/sla/slagence_fpi83/Images/voletsN.gif','/z/sla/slagence_fpi83/Images/bouleRJ1.gif')" TOPMARGIN="0" bgcolor="FFFFFF">
...
.txtCouleur1{font-size: 12px; font-weight: bold; color: #DE2486;}
...
A:hover {font-size: 12px; font-weight: bold; color: #FAC2DE;}
A.lien {font-size: 12px; font-weight: bold; color: #ffffff;}
A.lien:hover {font-size: 12px; font-weight: bold; color: #000000;}

/*TABLEAUX*/
.tabFond1{background-color: #FFE3F6; border-color: #2F2F77; border-width:0; border-style:solid; padding:2;}
.tabFond2{background-color: #ffffff; border-color: #6934FF; border-width:0; border-style:solid; padding:2;}
.tabTitre{background-color: #F53A9C; color: #000000; font-size: 13px; font-weight: bold;}
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td>
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					  <td height="145"> 
						<center>
						  <font size="2"><b><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="350" height="50">
							<param name=movie value="$$_$$titre.swf">
							<param name=quality value=high>
							<embed src="$$_$$titre.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="350" height="50">
							</embed> 
						  </object> <br>
						  <img src="images2/specialiste.gif" width="187" height="20"><font color="#FFFFFF">$$E:IMMOBW:AGENCE:REP:1$$<font size="3"><br>
			  ...
			  <tr>
				<td background="images2/titre.gif" height="30">
				  <center>
					<b><font color="592FCD">$$IF=:loc:FORM:T$$ LOCATIONS $$END$$ 
  ...
  <TABLE WIDTH="760" BORDER="0" CELLSPACING="0" CELLPADDING="0" HEIGHT="491">
	...
	<TABLE WIDTH="170" BORDER="0" CELLSPACING="0" CELLPADDING="0" height="480">
	  ...
	  <table width="170" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td background="images2/fond_mention.gif" width="170" height="54"> 
			<center>
			  r&eacute;alisations et mentions l&eacute;gales : <a href="/offres.htm">Seloger</a> 
			</center>
		  </td>
		</tr>
	  </table>
...
</center>$$REM$$ début macros concernant l'affichage des pages ventes, locations, viager, locations vacances ...ect mettre le nombre 0 ou 1 selon si vous voulez l'aficher ou non. 
$$SET:PAGE:IDTB1=1$$ Appartements 
$$SET:PAGE:IDTB2=1$$ Maisons / Villas 
$$SET:PAGE:IDTB3=1$$ Terrains 
$$SET:PAGE:IDTB4=1$$ Commerces 
$$SET:PAGE:IDTB5=1$$ bureaux 
$$SET:PAGE:IDTB6=1$$ divers 
$$SET:PAGE:IDTB7=0$$ parking
$$SET:PAGE:IDTB8=0$$  Locaux
$$SET:PAGE:IDTB9=0$$ Immeuble
$$SET:PAGE:IDTB10=0$$ Hangar
$$SET:PAGE:IDTB11=0$$ Chateau
$$SET:PAGE:IDTB12=0$$ Hotel Particulier
 
$$SET:PAGE:PIECES=1$$ Affiche les pieces 
$$SET:PAGE:BUDGET=1$$ Affiche budget max/min 
$$SET:PAGE:SURFACE=1$$ Affiche surface 
$$SET:PAGE:FRAICHEUR=0$$ Affiche - de 8 jours 
$$SET:PAGE:PROXIMITE=1$$ Affiche les champs : villes, départements et codes postaux fin macros concernant l'affichage des pages ventes, locations, viager, locations vacances ...ect 
$$END$$ 
