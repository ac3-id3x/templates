...
<body background="lesvillasfon.GIF" bgcolor="white" text="#000000" link="#FF0080" vlink="gray" alink="#FE8B5A" leftmargin="0" marginwidth="0">
<div align="left">
<table border="0" width="812" cellpadding="0">
    <tr>
        <td width="703">
                <!--NAMO_NAVBAR_START B H C  -->
<div align="center">
<img src="/z/sla/slagence_ygimmobilier/nav/nav_shades_of_blue_lesvilla_bhb.gif" name="nav_lesvilla_BH0" border="0" class="namo-banner" alt="    Les Villas">
</div>
                <!--NAMO_NAVBAR_END--></td>
        <td width="103">
    ...
    <tr>
        <td width="703" valign="top">
                <p align="left" style="margin-top:0; margin-left:40;">&nbsp;</p>
                <p align="left" style="margin-top:0; margin-left:40;">&nbsp;</p>
            <p align="left" style="margin-top:0; margin-left:40;">&nbsp;</p>
                <p align="left" style="margin-top:0; margin-left:40;">&nbsp;</p>
                <p align="left" style="margin-top:0; margin-left:40;">&nbsp;</p>
                ...
                <p align="left" style="margin-top:0; margin-left:40;">&nbsp;</p>
                <p align="left" style="margin-top:0; margin-left:40;">&nbsp;</p>
            <p align="left" style="margin-top:0; margin-left:40;"><font size="2"><a href="mailto:y.g.immobilier@wanadoo.fr">y.g.immobilier@wanadoo.fr</a></font></p>
        </td>
        <td width="103" valign="top">
            <p align="left" style="margin-top:0; margin-left:0;">&nbsp;</p>
                <!--NAMO_NAVBAR_START T V L h-->
<div align="left">
<a href="accueil.html" onmouseover="na_change_img_src('nav_lesvilla_TV0', 'document', '/z/sla/slagence_ygimmobilier/nav/nav_shades_of_blue_accueil_tvr.gif', true)"
...
<img src="/z/sla/slagence_ygimmobilier/nav/nav_shades_of_blue_lesvilla_tvh.gif" name="nav_lesvilla_TV2" border="0" class="namo-hibutton2" alt="    Les Villas"><br>
<a href="appartem.html" onmouseover="na_change_img_src('nav_lesvilla_TV3', 'document', '/z/sla/slagence_ygimmobilier/nav/nav_shades_of_blue_appartem_tvr.gif', true)"
