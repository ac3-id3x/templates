		...
		<tr bgcolor="C24B67"> 
		  ...
		  <td width="79%"> 
		   ...
		   $$B:IMMOBW:AGENCETRANSACTIONS:REP:1$$ $$BIF:IMMOBW:AGENCETRANSACTIONS:REP$$ 
			  $$DO:0:99$$ $$IF=:1:IMMOBW:AGENCETRANSACTIONS:REP:IDTYPETRANSACTION$$ 
            ...
            <img src="images/limoges-1.jpg" width="303" height="216"> <br>
            <br>
            <img src="images/limoges-3.jpg" width="303" height="214"> <br>
			<BR>
			  $$END$$ <br>
