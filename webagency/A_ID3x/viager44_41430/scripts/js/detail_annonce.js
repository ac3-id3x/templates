...
$(document).ready(function() {
	...
	$('.bouton-ajouter-selection-detail').on('click',function(e) {
		...
		$.ajax({
			...
			success: function(data) {
				$this.unbind('click');
				$this.removeClass('bouton-ajouter-selection-detail').attr('data-original-title',titleData).tooltip('fixTitle').find('img').attr('src','/z/webagency/slagence_X_V5/images/widget/star_ok.png').removeClass('bouton-ajouter-selection-detail');
