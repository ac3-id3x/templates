$(document).ready(function() {
	...
	var $length = Math.ceil( ( $('#moduleTallinn').find('li').length-1 ) /4  )*192;	
	...
	$('#moduleTallinn .downNav').click(function() {
		if(bouton == 0) {
			...
			//if($next.length > 0) {
				...
				$calculTop = (($(this).parent().parent().children('.listingAnnonce').find('li').length /2 ) - 2) * $heightA;
