...
function rollover(n) {
	...
	document.getElementById("mn"+n).style.backgroundPosition = "0 -48px";
	document.getElementById("mn"+n).style.color = "#c30c26";
	opened = n;
}
...
function closeMenu() {
	...
	document.getElementById("mn"+opened).style.color = "#751321";
}
