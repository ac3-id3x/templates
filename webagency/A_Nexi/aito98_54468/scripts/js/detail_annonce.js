    ...
    $('.bouton-ajouter-selection-detail').on('click',function(e) {
        ...
        if(thisIcone.hasClass('aito-icon-star-full')){
            $.ajax({
                ...
                cache:false,
                success: function(data) {
                    $this.attr('data-original-title',titleDone).tooltip('fixTitle').find('i').attr('class','aito-icon-star-empty');
                }
            });
        }else{
            $.ajax({
                ...
                cache:false,
                success: function(data) {
                    $this.attr('data-original-title',titleData).tooltip('fixTitle').find('i').attr('class','aito-icon-star-full');
                }
            });
        };
