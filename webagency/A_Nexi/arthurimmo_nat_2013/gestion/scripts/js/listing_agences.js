...
function getGeoloc() {
	...
	if(locationUserVal.toUpperCase() == 'REUNION' ||  locationUserVal.toUpperCase() == 'MARTINIQUE' ||  locationUserVal.toUpperCase() == 'GUADELOUPE'){
		...
		console.log(locationUserVal);
		if(locationUserVal.toUpperCase() == 'ARDECHE' || locationUserVal.toUpperCase() == 'ARDÈCHE') {
			locationUserVal += ' departement';
		}
		if(locationUserVal.toUpperCase() == 'MATHA') {
			locationUserVal += ' charente';
		}
		if(locationUserVal.toUpperCase() == 'SAINT CYPRIEN') {
			locationUserVal += ' 66';
		}
		if(locationUserVal.toUpperCase() == 'SAINT MARCELLIN') {
			locationUserVal += ' 38';
		}
		if(locationUserVal.toUpperCase() == 'POUILLY SUR LOIRE') {
			locationUserVal += ' 58';
		}
	...
	if(locationUserVal.length > 2) {
		 ...
		 if( locationUser.val() == '' ){
		 	$("#wrap-liste-agences").slideDown("slow");
		 }else{
		 	$("#wrap-liste-agences").slideUp("slow");
			}
	} else {
