...
$$B:IMMOBW:ANN-REFINER:~params:VAL:PARAMSREFINE:~idqfix:1:~advanced:VAL:ADVANCEDREFINE:~addmisc:1:ALIAS:REFINER$$
	...
	$$BFIN$$	
		...
		"typebien": "$$FORM:IDTYPEBIEN gettypebien$$",
		"soustypebien": "$$FORM:IDSOUSTYPEBIEN getsoustypesbien$$",
		"localite": "$$FORM:CI codeinsee2ville field 1$$ $$FORM:CP cp2dep field 1$$ $$FORM:DIV$$ $$IF0:FORM:CI$$$$IF0:FORM:CP$$$$IF0:FORM:DIV$$FRANCE$$END$$$$END$$$$END$$",
		"idvpa":"$$FORM:IDVPA$$",
