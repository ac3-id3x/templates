...
var moduleDiv = 	$('.rotateRome');
		...
		var objModule = {	
			...
			decalage2: ($('#masqueModuleRome2').children('ul').find('li').outerWidth(true)) * 2,
			decalage3: ($('#masqueModuleRome3').children('ul').find('li').outerWidth(true)) * 2,
	...
	var startSlide = function() {
		...
		var $container3 = $("."+this.idDiv).children('#masqueModuleRome3').children('ul');
			...
			var $max2 = ($countLi2/2) * this.decalage;
			var $max3 = ($countLi3/2) * this.decalage;
