...
function veOnMouseOver(e) 
{
	...
	{
		var pin= vemap.GetShapeByID(e.elementID);
		var html='<a style="float:right;" href="javascript:flyoutZoom(\''+e.elementID+'\');" title="Centrer le secteur"><img src="$$-$$map/img/rouge_picto-centrer.gif" alt="Centrer le secteur" title="Centrer le secteur" /></a>'
		...
		if (pin.infos.nb<1000)
			...
			+getPluriel(pin.infos.nb,'la liste de ce secteur','la liste de ce secteur')
			+'</a><br/>';
		else
