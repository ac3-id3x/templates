...
function Visionneuse() {
	...
	function actionAffiche(imageNum){
		...
		for ( i = 0; i < afficheur.getElementsByTagName("img").length; i++ ){
			...
			afficheur.getElementsByTagName("img")[i].style.height = "216px";	
		}
		...
		{
			document.getElementById("boutonPrec").style.display='none';
			document.getElementById("boutonSuiv").style.display='none';
		}
