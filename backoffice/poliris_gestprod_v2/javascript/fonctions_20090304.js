...
function GetEtat (monurl, mydiv, iddossier, idetat)
{
	mesparametres = 'iddossier='+iddossier+"&idetat="+idetat;
...
function UpdateEtat(myurl, iddossier, params)
{
	myselect = document.getElementById('cboetatdossier');
	
	params = "u=GDP2:MAJ_ETAT&page_ok=&page_err=&iddossier="+iddossier+"&idetat="+myselect.options[myselect.selectedIndex].value
