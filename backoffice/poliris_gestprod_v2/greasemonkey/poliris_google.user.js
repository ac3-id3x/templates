...
// @namespace       http://gestprod.poliris.com/greasemonkey/
// @description     Modification des résultats Google (coloration, liens)
		...
		for( i=0; i< resultat.length; i++ ) {
			...
			for( j=0; j< urls.length; j++ ) {
				if( urls[j] == resultat[i].url ) {
					...
					//alert("Trouvé : " + resultat[i].url + ", : " + obj );
		      obj.setAttribute("style","background-color: #00FF00;");
			...
			if( obj == null ) {
				alert("Non Trouvé : " + resultat[i].url );
			}
		}
	}
}
