...
{		
	...
	if (confirm("Confirmer la modification d'ordre?"))
		location.href="/easa_bo,txt_reorder.htm?redirect="+redirect+"&idCategorie="+idCatParent+"&orderList="+idListTxt+"&init="+init
	return false;
}
...
{	
	...
	if (confirm("Confirmer la modification d'ordre?"))
		location.href="/easa_bo,cat_reorder.htm?redirect="+redirect+"&idCatParent="+idCatParent+"&orderList="+idListCat+"&init="+init
	return false;
}
