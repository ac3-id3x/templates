$(".group1").colorbox({rel:'group1', slideshow:true, overlayClose:false, slideshowSpeed:5000, current:"Image {current} sur {total}", slideshowStart:"",slideshowStop:"", slideshowAuto:false});
$(".group2").colorbox({rel:'group2', slideshow:true, overlayClose:false, slideshowSpeed:5000, current:"Image {current} sur {total}", slideshowStart:"",slideshowStop:"", slideshowAuto:false});
$(".group3").colorbox({rel:'group3', slideshow:true, overlayClose:false, slideshowSpeed:5000, current:"Image {current} sur {total}", slideshowStart:"",slideshowStop:"", slideshowAuto:false});
$(".group4").colorbox({overlayClose:false});
$(".group5").colorbox({overlayClose:false});	
$(".zoom_template").colorbox();
$(".voir_template").colorbox();
...
jQuery(document).ready(function() {
	...
	$('.video-block').find('img').click(function(e) {
		...
		$('.video-detail').show(50, function() {
			$('.video-detail').html('<iframe width="640" height="394" src="//www.youtube.com/embed/-dcLS1Zg7RM?autoplay=1&rel=0" frameborder="0" allowfullscreen></iframe>');
			//player.playVideo();
		});
	});
