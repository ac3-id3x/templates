...
function AutoSuggest(elem, suggestions)
{
	...
	var TAB = 9; //And yes TAB = 9 not 13...
	var ESC = 27;
	var KEYUP = 38;
	var KEYDN = 40;
	...
	********************************************************/
	this.useSuggestion = function()
	{
		if (this.highlighted > -1)
		{
			...
			if (me.urlredir!=null) {
				...
				switch(choisi.t)
				{
					...
					case 2: // dep
						...
						choisi.d=choisi.cp;
						break;
					case 8: // sdiv a l'etranger
						surl="sdiv";
					break;
					case 3: // region
					case 9: // region a l'etranger
						surl="div";
					break;
					case 4://idlieu
						surl="idlieux";
			...
			if (loadci){
					loadci(choisi.d,this.elem.value);
				}
				else{	
 					loadci(choisi.d,this.elem.value);
				}
	...
	********************************************************/
	this.getEligible = function()
	{
		...
		sndReq('/js,ajax,villequery.htm?ville='+this.inputText);
	};
