...
(function($) { // Compliant with jquery.noConflict() 
    $.fn.jCarouselLite = function(o) { 
        ...
        return this.each(function() { // Returns the element collection. Chainable. 
            ...
            var div = $(this), ol = $(o.carousel), tLi = $(o.panel, o.carousel), tl = tLi.size(), v = o.visible; 
            ...
            var li = $(o.panel, o.carousel), itemLength = li.size(), curr = o.start; 
            ...
            ol.css({ margin: "0", padding: "0", position: "relative", "list-style-type": "none", "z-index": "1" }); 
            div.css({ overflow: "hidden", position: "relative", "z-index": "2", left: "0px" }); 

            var liSize = o.vertical ? height(li) : width(li); // Full li size(incl margin)-Used for animation 
            var liRowSize = o.vertical ? width(li) : height(li); //ADDED: size of the li's row 
            var olSize = ((liSize * itemLength) / o.rows) + (liSize / 1.5); // size of full ul(total length, not just for the visible items) 
            ...
            ol.css(sizeCss, olSize + "px").css(animCss, -(curr * liSize)); 
                        ...
                        ol.css(rowCss, rowSize + "px"); //ADDED: Height of the DIV; MODIFIED: height of ol instead of div 
            ...
            function go(to) { 
                if (!running) { 
                    ...
                    if (o.circular) { // If circular we are in first or last, then goto the other end 
                        ...
                        if (to <= o.start - v - 1) { // If first, then goto last 
                            ol.css(animCss, -((itemLength - (v * 2)) * liSize) + "px"); 
                ...
                $(o.btnPrev + "," + o.btnNext).removeClass("disabled"); 
                    //ADDED: This determines when to add the disabled class to the link when more than 1 row is viewable                     
                                        $( (curr - o.scroll < 0 && o.btnPrev) || (curr + o.scroll > ((itemLength - v) / o.rows) && o.btnNext) || [] ).addClass(o.disableClass); 
                } 
                ...
                return false; 
                                ...
                                $(liElements).each(function(i){ 
                                        if(i != curr){ 
                                                ...
                                                if($(this).children().children("object").size() > 0){ 
                                                        ...
                                                        //videoPlayer.runCommand(["Video Player 1", "togglePlay", false, 'off']); 
                                                } 
                                        } else { 
                                                $(this).children().children("object").each(function(){ 
                        ...
                        function update_lables(curr){ 
                                ...
                                var nextREPLACE = $(kids[nextPos]).children().children("caption").html(); 
                                var prevREPLACE = $(kids[prevPos]).children().children("caption").html(); 

                                var re = new RegExp(o.btnRegExp, "g"); 
                                        
                                var btnNextHtmlNew = $(o.btnNext).parent().html().replace(re, nextREPLACE); 
                                var btnPrevHtmlNew = $(o.btnPrev).parent().html().replace(re, prevREPLACE); 
                                        ...
                                        $(o.carousel).each(function(i){ 
                                                if($(this).children().size() > 1) { 
                                                        ...
                                                        $(this).children().each(function(j){ 
                                                                panelNum = j; 
                                                                linkNum = (j+1);   
      $(carouselNavDiv).append('<li class="indicator">'+linkNum+'</li>');   
                                                        });	     
                        ...
                        function update_navigation(curr){ 
                                ...
                                var pos = (kids.size()-cloneVal <= curr) ? (curr > kids.size()-cloneVal) ? 2 : kids.size()-cloneVal : curr; 
