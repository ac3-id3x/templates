...
//	email  : pinotoy@yahoo.com
	...
	*/
	...
	function closeCalendar() {
		...
		document.getElementById('dt_dispo_j').value = dateSelected;
		document.getElementById('dt_dispo_m').value = monthSelected + 1;
		document.getElementById('dt_dispo_a').value = yearSelected;
	}
