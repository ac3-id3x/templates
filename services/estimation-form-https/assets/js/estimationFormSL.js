...
var _confHouseUrlEstim = "http://evaluationNEW-svcdev.pericles.fr/api/estimation/lci/ObtenirEstimationMaison"; // (LCI: Integ, Re7); {"http://evaluation-svc-new.pericles.fr/api/estimation/lci/ObtenirEstimationMaison" (Prod LCI)}
var _confApartmentUrlEstim = "http://evaluationNEW-svcdev.pericles.fr/api/estimation/lci/ObtenirEstimationAppartement"; // (LCI: Integ, Re7); {"http://evaluation-svc-new.pericles.fr/api/estimation/lci/ObtenirEstimationAppartement" (Prod LCI)}
